...
def _static_catalog() -> tuple[ModelInfo, ...]:
    return (
        ...
        ModelInfo(
            ...
            description="Fast, low-cost generalist with a huge context window.",
            ...
            speed="fast",
            cost_tier="low",
            badges=("Fast", "Low cost", "Long context", "Multimodal"),
            task_scores={
                "coding": 0.70,
                "research": 0.75,
                "writing": 0.70,
        ...
        ModelInfo(
            ...
            description="Strong reasoning over very large or multimodal context.",
            strengths=(
            ...
            speed="slow",
            cost_tier="medium",
            badges=("Best for research", "Long context", "Multimodal"),
            task_scores={
                "coding": 0.85,
                "research": 0.90,
                "writing": 0.80,
        ...
        ModelInfo(
            ...
            id="gpt-5.2",
            label="GPT-5.2",
            description="Flagship model for coding, tool use, and hard reasoning.",
            ...
            speed="medium",
            cost_tier="high",
            badges=("Best for coding", "Multimodal"),
            task_scores={
                "coding": 0.92,
                "research": 0.85,
                "writing": 0.85,
        ...
        ModelInfo(
            ...
            id="gpt-5-mini",
            label="GPT-5 mini",
            description="Quick, inexpensive choice for everyday questions.",
        ...
        ModelInfo(
            ...
            speed="medium",
            cost_tier="high",
            badges=("Best for writing", "Best for research"),
            task_scores={
                "coding": 0.93,
                "research": 0.92,
                "writing": 0.93,
        ...
        ModelInfo(
            ...
            description="Balanced quality and speed; dependable for most work.",
